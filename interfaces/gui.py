...
class GUI:
    ...
    def setup_country_tab(self, parent):
        ...
        # Info
        info_text = """
        This analysis shows which countries and continents are viewing the document.
    ...
    def setup_browser_tab(self, parent):
        ...
        # Info
        info_text = """
        Raw histogram shows detailed user agent strings.
    ...
    def setup_graph_tab(self, parent):
        ...
        # Info
        info_text = """
         This generates a graph showing relationships between documents and readers.
         Requires graphviz to be installed for PDF generation.
        """
        ttk.Label(parent, text=info_text, foreground="gray", wraplength=700).pack(pady=10)
